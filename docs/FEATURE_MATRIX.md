...
| POL-04 | Manifesto priorities and final score | Planned | Player-defined goals without hiding neglected systems | [`docs/GAME_DESIGN.md`](GAME_DESIGN.md), [`docs/METRICS.md`](METRICS.md) | Formula specification | Campaign setup, geometric/arithmetic scoring, 2036 report |
...
| POL-06 | Sourced real-party mappings | Planned | Evidence-led comparison without party-name modifiers | [`docs/POLITICAL_MODEL.md`](POLITICAL_MODEL.md), [`docs/DATA_SOURCES.md`](DATA_SOURCES.md) | Architecture rule | Add only after generic engine validation and legal/editorial review |
